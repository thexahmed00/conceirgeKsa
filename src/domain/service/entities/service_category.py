...
class ServiceCategory:
    ...
    @classmethod
    def create(cls, slug: str, name: str, display_order: int = 0) -> "ServiceCategory":
    ...
    def update(self, name: Optional[str] = None, display_order: Optional[int] = None) -> None:
    ...
    def __repr__(self) -> str:
        return f"ServiceCategory(id={self.category_id}, slug={self.slug}, name={self.name})"
